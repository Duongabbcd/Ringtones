...
import com.ezt.ringify.ringtonewallpaper.databinding.BottomSheetWallpaperDownloadBinding
...
class DownloadWallpaperBottomSheet(private val context: Context) : BaseBottomSheetDialog<BottomSheetWallpaperDownloadBinding>(context) {
    ...
    fun setType(type: String = "download") {
        title = when(type) {
            ...
            else -> context.getString(R.string.download_title_2)
        }
