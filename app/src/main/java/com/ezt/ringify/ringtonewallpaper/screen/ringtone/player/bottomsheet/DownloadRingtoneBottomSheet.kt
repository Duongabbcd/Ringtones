package com.ezt.ringify.ringtonewallpaper.screen.ringtone.player.bottomsheet
...
class DownloadRingtoneBottomSheet(private val context: Context, private val type: String = "download") : BaseBottomSheetDialog<BottomSheetRingtoneDownloadBinding>(context) {
    override fun getViewBinding(): BottomSheetRingtoneDownloadBinding {
        return BottomSheetRingtoneDownloadBinding.inflate(layoutInflater)
    }
