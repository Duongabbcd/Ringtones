    ...
    open class CropResult internal constructor(
        ...
        fun getBitmap(context: Context): Bitmap? = bitmap ?: try {
            when {
                ...
                else -> @Suppress("DEPRECATION") MediaStore.Images.Media.getBitmap(
                    context.contentResolver,
                    uriContent
                )
            }
                ...
                ?: if (attrs != null) {
                    ...
                    try {
                        ...
                        CropImageOptions(
                            ...
                            maxZoom = a.getInteger(
                                R.styleable.CropImageView_cropMaxZoom,
                                default.maxZoom
                            ),
                            ...
                            fixAspectRatio = a.getBoolean(
                                R.styleable.CropImageView_cropFixAspectRatio,
                                default.fixAspectRatio
                            ) || a.hasValue(R.styleable.CropImageView_cropAspectRatioX) && a.hasValue(
                                R.styleable.CropImageView_cropAspectRatioX
                            ),
                        )
                    } finally {
